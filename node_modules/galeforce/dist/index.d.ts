import { Tier, Division, Game, ValorantRegion, LeagueRegion, RiotRegion, LeagueQueue, ValorantQueue, DataDragonRegion, LorRegion } from './riot-api';
...
declare class Galeforce {
    ...
    lol: {
        ...
        tournament: {
            ...
            code: {
                 ...
                 */
                create: (stub?: boolean) => PostTournamentCodes;
                /**
                 * Action constructor corresponding to the following endpoints:
             ...
             * Tournament stub endpoints can be accessed by passing in `true`.
             */
            event: (stub?: boolean) => GetLobbyEvents;
            /**
             * Action constructor corresponding to the following endpoints:
             ...
             * Tournament stub endpoints can be accessed by passing in `true`.
             */
            provider: (stub?: boolean) => PostProviders;
            /**
             * Action constructor corresponding to the following endpoints:
             ...
             * Tournament stub endpoints can be accessed by passing in `true`.
             */
            tournament: (stub?: boolean) => PostTournaments;
        };
        /**
        ...
        ddragon: {
            ...
            champion: {
                ...
                art: {
                     ...
                     * Returns data as a `Buffer` object containing PNG data.
                     */
                    passive: () => GetDataDragonChampionPassiveArt;
                };
            };
            spell: {
                /**
    ...
    lor: {
        ...
        ddragon: {
            ...
            core: {
                 ...
                 * Returns data as a `Buffer` object.
                 */
                bundle: () => GetLorDataDragonCoreBundle;
                /**
                 * Action constructor corresponding to the following Data Dragon files:
                 ...
                 */
                globals: () => GetLorDataDragonCoreGlobals;
                art: {
                    /**
                     * Action constructor corresponding to the following Data Dragon files:
                     ...
                     * Returns data as a `Buffer` object containing PNG data.
                     */
                    regionIcon: () => GetLorDataDragonCoreRegionIcons;
                };
            };
            /**
            ...
            set: {
                ...
                bundle: {
                     ...
                     * Returns data as a `Buffer` object.
                     */
                    full: () => GetLorDataDragonFullSetBundle;
                    /**
                     * Action constructor corresponding to the following Data Dragon files:
                     * - (**GET**) `/${version}/set${lorSet}-${locale}.zip`
                     *
                     ...
                     * Returns data as a `Buffer` object.
                     */
                    lite: () => GetLorDataDragonLiteSetBundle;
                };
                /**
                 * Action constructor corresponding to the following Data Dragon files:
                ...
                card: {
                    ...
                    art: {
                         ...
                         * Returns data as a `Buffer` object containing PNG data.
                         */
                        game: () => GetLorDataDragonSetCardArt;
                        /**
                         * Action constructor corresponding to the following Data Dragon files:
                         ...
                         * Returns data as a `Buffer` object containing PNG data.
                         */
                        full: () => GetLorDataDragonSetCardArt;
                        /**
                         * Action constructor corresponding to the following Data Dragon files:
                         ...
                         * Returns data as a `Buffer` object containing PNG data.
                         */
                        alt: () => GetLorDataDragonSetCardArt;
                        /**
                         * Action constructor corresponding to the following Data Dragon files:
                         ...
                         * Returns data as a `Buffer` object containing PNG data.
                         */
                        altFull: () => GetLorDataDragonSetCardArt;
                    };
                };
            };
        };
    ...
    lcd: {
        ...
        active: {
             ...
             */
            player: () => GetLiveClientActivePlayer;
            /**
             * Action constructor corresponding to the following Live Client Data endpoints:
             ...
             */
            name: () => GetLiveClientActivePlayerName;
            /**
             * Action constructor corresponding to the following Live Client Data endpoints:
             ...
             */
            abilities: () => GetLiveClientActivePlayerAbilities;
            /**
             * Action constructor corresponding to the following Live Client Data endpoints:
             ...
             */
            runes: () => GetLiveClientActivePlayerRunes;
        };
        /**
        ...
        player: {
             ...
             */
            scores: () => GetLiveClientPlayerScores;
            /**
             * Action constructor corresponding to the following Live Client Data endpoints:
             ...
             */
            summonerSpells: () => GetLiveClientPlayerSummonerSpells;
            /**
             * Action constructor corresponding to the following Live Client Data endpoints:
             ...
             */
            runes: () => GetLiveClientPlayerRunes;
            /**
             * Action constructor corresponding to the following Live Client Data endpoints:
             ...
             */
            items: () => GetLiveClientPlayerItems;
        };
        /**
         * Action constructor corresponding to the following Live Client Data endpoints:
...
declare namespace Galeforce {
    ...
    export { Division, Tier, Game, Region, Queue, };
}
export = Galeforce;
