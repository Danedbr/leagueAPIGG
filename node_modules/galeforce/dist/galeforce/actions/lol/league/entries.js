...
const BaseAction = (0, mixins_1.TakesQueue)({}, (0, mixins_1.TakesTier)((0, mixins_1.TakesDivision)((0, mixins_1.TakesSummonerId)((0, mixins_1.TakesQuery)({}, (0, mixins_1.TakesRegion)({}, action_1.default))))));
class GetLeagueEntries extends BaseAction {
    ...
    inferEndpoint() {
        if (typeof this.payload.summonerId !== 'undefined') {
            this.payload.endpoint = riot_api_1.ENDPOINTS.LEAGUE.SUMMONER_ID;
        }
            ...
            if (typeof this.payload.tier !== 'undefined' && [riot_api_1.Tier.MASTER, riot_api_1.Tier.GRANDMASTER, riot_api_1.Tier.CHALLENGER].includes(this.payload.tier)) {
                ...
                this.payload.endpoint = riot_api_1.ENDPOINTS.LEAGUE.ENTRIES_BY_RANK_EXP;
            }
            else {
                this.payload.endpoint = riot_api_1.ENDPOINTS.LEAGUE.ENTRIES_BY_RANK; // set to default endpoint
            }
        }
        else {
...
exports.default = GetLeagueEntries;
