...
import { Tier, LeagueRegion, LeagueQueue } from '../../../../riot-api';
...
declare const BaseAction: {
    ...
    new (...args: any[]): {
        query<K_4 extends import("../../mixins/query").QueryChainable<GetLeagueEntriesQuery> & import("../../mixins/executable").Executable>(this: K_4, query: GetLeagueEntriesQuery): Omit<K_4, "query">;
    };
} & {
    new (...args: any[]): {
        region<K_5 extends import("../../mixins/region").RegionChainable<LeagueRegion> & import("../../mixins/executable").Executable>(this: K_5, region: LeagueRegion): Omit<K_5, "region">;
    };
} & typeof Action;
