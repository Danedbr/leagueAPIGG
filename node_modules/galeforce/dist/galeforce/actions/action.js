...
const actionDebug = (0, debug_1.default)('galeforce:action');
/**
...
class Action {
    ...
    constructor(submodules) {
        ...
        this.payload = (0, payload_1.CreatePayloadProxy)({
            _id: (0, uuid_1.v4)(),
        });
            ...
            if (axios_1.default.isAxiosError(e)) {
                ...
                switch ((_b = e.response) === null || _b === void 0 ? void 0 : _b.status) {
                    ...
                    default:
                        ...
                        throw new Error(`[galeforce]: Data fetch failed with status code ${(_c = e.response) === null || _c === void 0 ? void 0 : _c.status}`);
                }
            }
            else {
